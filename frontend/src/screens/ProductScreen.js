...
const ProductScreen = ({history, match}) => {
    ...
    const {loader: loadingProductReview, error: errorProductReview, success: successProductReview} = productReviewCreate;
                                        ...
                                        {userInfo ? (
                                                <Form onSubmit={submitHandler}>
                                                    ...
                                                    <Form.Group controlId='comment'>
                                                        ...
                                                        <Form.Control type='textarea' row='3' value={comment}
